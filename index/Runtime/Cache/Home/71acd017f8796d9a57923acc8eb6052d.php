...
.Box .Box_con .conbox ul li {float: left;width: 230px;height: 255px;margin-left: 20px;overflow: hidden;}
/*	.Box .Box_con .conbox ul li:first-child {margin-left: 0;}*/
.Box .Box_con .conbox ul li .aa{width: 230px;height: 200px;overflow: hidden;}
.Box .Box_con .conbox ul li img {display: block;width: 230px;height: 200px;transition: all 0.5s;}
...
<div class="yBanner">
	<div id="banner" class="flexslider">
		<ul class="slides">	
			<?php if(is_array($ban)): $i = 0; $__LIST__ = $ban;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li><!-- window.location='http://www.ygqq.com/static/zt/app3/load.htm' -->
