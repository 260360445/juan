...
class GroupPage{
     ...
     * @param String $page_name 静态页参数名称
     * @param array $parameter  分页跳转的参数
     */
    public function __construct($totalRows, $listRows=20, $page_name='p',$parameter = array()) {
//        C('VAR_PAGE') && $this->p = C('VAR_PAGE'); //设置分页参数名称
    ...
    public function show() {
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return "<div class='task-b'><ul class=\"pagination\">{$page_str}</ul></div>";
    }
}
