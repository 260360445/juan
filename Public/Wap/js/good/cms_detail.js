...
var openApp = function (e) {
        ...
        a.src = "taobao://" + t, a.style.display = "none", document.body.appendChild(a), window.location = e
    },
    openAppIos9 = function (e) {
        var t = e.replace("http://", "").replace("https://", ""),
            a = "taobao://" + t;
        window.location = a, window.setTimeout(function () {
            window.location = e
        }, 3e3)
    },
    is_weixin = function () {
...
$(".pic-detail-btn span.pic-detail-btn-span").click(function () {
    "none" == $(".pic-detail-show").css("display") ? ($(this).hasClass("cur") ? $(this).find("i").html("点击展开<em></em>") : ($(this).addClass("cur"), $(this).find("i").html("点击收起<em></em>")), $(".pic-detail-show").css("display", "block")) : ($(this).removeClass("cur"), $(this).find("i").html("点击展开<em></em>"), $(".pic-detail-show").css("display", "none")), isLoad || ($("span.loadding-lab").fadeIn(300), setTimeout(function () {
        $.ajax({
            type: "get",
            async: !1,
            ...
            success: function (e) {
                if ($("span.loadding-lab").fadeOut(300), e.data.images.length > 0)
                    for (var t = 0; t < e.data.images.length; t++) $(".pic-detail-show").append('<p><img src="' + e.data.images[t] + '"/></p>');
                isLoad = !0
            }, error: function () {}
        })
    }, 300))
    ...
    $(".weixin-tip").css("display", "none"), $(".buy-wrapper").css("display", "block"), $("#myVideo").css("display", "block")
    ...
    if ("micromessenger" == t.match(/MicroMessenger/i)) {
        ...
        /iphone|ipad|ipod/.test(t) ? $(".wechat-brow").addClass("iosChat") : /android|adr|linux/.test(t) && $(".wechat-brow").addClass("androidChat"), $("#myVideo").css("display", "none")
    }
    ...
    var t = null,
        a = function (e) {
            ...
            if (t > 0) {
                ...
                if (!(e > 0)) return !1;
                if (0 == a(e - 1)) return 3 == e ? $(".outTime b").eq(e).html(0) : $(".outTime b").eq(e).html("00"), !1;
    ...
    var o = new Clipboard(".keycope", {
        text: function (e) {
            return e.getAttribute("aria-label")
        }
    });
    o.on("success", function (e) {
        e.trigger.style.background = "#67cf84", e.trigger.parentNode.style.borderColor = "#复制成功", e.trigger.innerHTML = "复制成功", e.clearSelection()
    ...
    var t = {
        getPixelRatio: function (e) {
            ...
            var e = this;
            if (window.canvasImage) return e.getImagesCode(0, 0), !1;
            var t = layer.load(),
                a = layer.open({
                    type: 2,
                    title: !1,
            ...
            layer.open({
                ...
                success: function () {
                    layer.close(t), layer.close(e), n.closeAll(".buy-copy")
                }
            })
            ...
            var t = this,
                ...
                i = function (e) {
                    ...
                    t.on("success", function (t) {
                        layer.msg("复制成功！"), $(e).addClass("active").html("复制成功"), $(".buy-box .cente-text").select(), t.clearSelection()
                    }), t.on("error", function (t) {
                        layer.msg("复制失败，请长按文字手动复制！"), $(e).addClass("active").html("复制失败"), t.clearSelection()
                    })
                };
            layer.open({
                type: 1,
                ...
                content: a,
                success: function () {
                    t.closeAll(".buy-copy"), i(".buy-copy .buy-btn-copy");
                    $(".cente-text .textarea").val();
                    $(".cente-text .textarea").on("touchend", function () {
            ...
            setTimeout(function () {
                ...
                if (document.body.createTextRange) {
                    ...
                    a.moveToElementText(t), a.select()
            ...
            $(".buy-wrapper-new *[weixin]").on("click", function () {
                return $("body").append('<div class="buy-weixin-msg"></div>'), $(".buy-weixin-msg").click(function (e) {
                    $(this).remove()
                }), !1
            })
        }
    };
    t.init(), e.$canvasImage = t
}(window);